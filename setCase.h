  ...
  double A1[m1][n1] = {  {   4. , -1. , -1. , -1. , -3. , -5.  } ,
			 ...
			 { -1.  , -1. ,  4. , -1. , -3. , -7.  } ,
			 { -1.  , -1. , -1. ,  4. , -6. , -2.  }    };
  double b1[n1]    =     {  1.  ,  3. ,  4. ,  2.              };
  
  // 4x4 with unique solution
  
  int   m2 = 4;
  int   n2 = 4;
  double A2[m2][n2] = {  {4.,-1.,-1.,3.} , {-1.,4.,-3.,10.} , {-1.,-1.,4.,5.} , {-3.,-1.,-1.,8.,7. } };
  double b2[n2]    = { 1., 3., 4.,4.};
  ...
  int   m5 = 3;
  int   n5 = 3;
  double A5[m5][n5] = {   {  3. , 5. , -4. }, { -3. , -2. , 4. } , { 6. , 1. , -8.  } };
  double b5[n5]    =  { 7., -1., -4.};
  ...
  int   m6 = 4;
  int   n6 = 4;
  double A6[m6][n6] = {  {4.,-1.,-1.,3.} , {3.,-10.,-1.,3.} , {-1.,-1.,-2.,-6.} , {-3.,-1.,-1.,-4.,-12. } };
  double b6[n6]     = { 1., 3., 4.,4.};
